...
export default function EdProfilePage() {
  ...
  const roleLabel = useMemo(() => {
    const raw = String(professional?.role || "");
    if (raw) return raw;
    ...
    >
      <div className="min-h-screen bg-[#0B1220]/85">
        ...
        <main className="container mx-auto px-4 py-6">
          ...
          <h1 className="text-2xl font-semibold text-white mb-4">My Account</h1>
              ...
              <div className="col-span-12 lg:col-span-9">
                <GradientContainer className="h-full">
                  <div className="rounded-2xl p-5 md:p-7">
                    <h3 className="text-white text-base md:text-lg font-semibold">Personal Details</h3>
